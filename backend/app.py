...
app = FastAPI(title="HCS Apple Technology Chatbot", version="1.0.0")
...
@app.get("/")
async def root():
    return {"message": "HCS Apple Technology Chatbot API", "status": "running"}
...
if __name__ == "__main__":
    ...
    logger.info("Starting HCS Apple Technology Chatbot API...")
